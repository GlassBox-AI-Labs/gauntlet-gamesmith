...
const loops: LoopApi = {
  ...
  artifacts: (loopId) => ipcRenderer.invoke(IPC.loop.artifacts, loopId),
  assetGallery: (loopId) => ipcRenderer.invoke(IPC.loop.assetGallery, loopId),
  revealArtifact: (loopId, kind) => ipcRenderer.invoke(IPC.loop.revealArtifact, loopId, kind),
