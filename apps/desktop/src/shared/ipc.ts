...
export const IPC = {
  publishing: { history: 'publishing:history', previewRelease: 'publishing:preview-release', unpublish: 'publishing:unpublish', cancelSignIn: 'publishing:cancel-sign-in', status: 'publishing:status', signIn: 'publishing:sign-in', signOut: 'publishing:sign-out', prepare: 'publishing:prepare', publish: 'publishing:publish' },
  harness: {
