import type { LoopModels, Verdict } from './loop'
...
11. Write ./${referenceDir}/manifest.json as valid JSON and audit every source attribution against the downloaded files.
