...
const loop: LoopRecord = {
  ...
  budgetUsd: null, models: { orchestratorHarness: 'codex', orchestratorModel: 'gpt-5.6-luna', orchestratorEffort: 'medium', subagentHarness: null, subagentModel: null, subagentEffort: 'medium', criticHarness: 'codex', criticModel: 'gpt-5.6-sol', criticEffort: 'high', referenceStudy: true, researchHarness: null, researchModel: null, researchEffort: 'medium', assetHarness: null, assetModel: null, assetEffort: 'medium' },
