...
function snapshot(offset: number, runIds: string[], totalRuns = 500): LoopSnapshot {
  return {
    loop: {
      ...
      maxRounds: 100, budgetUsd: null, models: { orchestratorHarness: 'claude', orchestratorModel: 'claude-opus-5', orchestratorEffort: 'high', subagentHarness: null, subagentModel: null, subagentEffort: 'medium', criticHarness: 'codex', criticModel: 'gpt-5.6-sol', criticEffort: 'high', researchHarness: null, researchModel: null, researchEffort: 'medium', assetHarness: null, assetModel: null, assetEffort: 'medium' },
