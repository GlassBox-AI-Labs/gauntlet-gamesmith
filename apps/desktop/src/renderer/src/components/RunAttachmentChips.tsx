...
export function RunAttachmentChips({ items, disabled, onRemove, onError }: { items: RunAttachment[]; disabled: boolean; onRemove: (id: string) => void; onError: (message: string) => void }): React.JSX.Element {
