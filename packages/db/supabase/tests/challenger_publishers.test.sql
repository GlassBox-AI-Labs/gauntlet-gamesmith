...
insert into auth.users(id,email,email_confirmed_at,raw_user_meta_data) values
 ...
 ('11111111-1111-4111-8111-111111111106','NEW@CHALLENGER.GAUNTLETAI.COM',now(),'{"publisher_name":"Game studio"}'),
 ('11111111-1111-4111-8111-111111111107','default@challenger.gauntletai.com',now(),'{}'),
 ('11111111-1111-4111-8111-111111111108','existing@challenger.gauntletai.com',now(),'{}');
...
insert into public.publishers(id,handle,display_name,email_domain_access) values
 ('11111111-1111-4111-8111-111111111108','challenger-existing','Existing studio',true);
...
select is(public.publisher_for_user('11111111-1111-4111-8111-111111111106')->>'display_name','Game studio','Verified exact domain enrolls case-insensitively');
...
select is(public.publisher_for_user('11111111-1111-4111-8111-111111111106')->>'handle','creator-11111111111141118111111111111106','Repeated enrollment preserves identity');
select is(public.publisher_for_user('11111111-1111-4111-8111-111111111107')->>'display_name','Game creator','Missing public name has a neutral default');
select is(public.publisher_for_user('11111111-1111-4111-8111-111111111107')->>'handle','creator-11111111111141118111111111111107','New profile URL uses a neutral handle');
select is(public.publisher_for_user('11111111-1111-4111-8111-111111111108')->>'handle','challenger-existing','Existing public profile URL stays stable');
select is(public.publisher_for_user('11111111-1111-4111-8111-111111111108')->>'display_name','Existing studio','Existing public name stays unchanged');
